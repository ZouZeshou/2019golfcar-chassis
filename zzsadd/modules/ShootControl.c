...
int16_t ShootFrequency = 20;//1000/5/10
int stirmotor_jam = 1;

struct pid s_stirmotor_outter_pid,s_stirmotor_inner_pid;
struct pid fric_l_pid,fric_r_pid;
...
void ShootInit (void)
{
	...
	pid_struct_init(&s_stirmotor_outter_pid,1250,1000,20,0,0);
	pid_struct_init(&s_stirmotor_inner_pid,10000,3000,30,0,0);
	pid_struct_init(&fric_l_pid,10000,6000,12,0,10);
	pid_struct_init(&fric_r_pid,10000,6000,12,0,10);
}
/**
 * @brief initialise the data will be used in shoot motor
 * @param None
...
//		rc_s1_press = 1;
//		mouse_l_press = 1;
//		StirMotorData.TargetPosition += 1 * STIRADDITION;//5
//	}
//	
//	if(RC_Ctl.rc.s1 == 3)
//	{
...
//	if(StirMotorDebug == 1)
//	{
//		s_stirmotor_outter_pid.kp = P;//0.3(*36)
//		s_stirmotor_outter_pid.ki = I;
//		s_stirmotor_outter_pid.kd = D;
//		s_stirmotor_outter_pid.errILim = 1000;
//		s_stirmotor_outter_pid.OutMAX = V1;//160
//		
//		s_stirmotor_inner_pid.kp = p;//100
//		s_stirmotor_inner_pid.ki = i;
//		s_stirmotor_inner_pid.kd = d;
//		s_stirmotor_inner_pid.errILim = 3000 ;
//		s_stirmotor_inner_pid.OutMAX = V2 ;//8000
//	}
	StirMotorData.Current = (int16_t)pid_calculate(&s_stirmotor_inner_pid,BackSpeed*0.166666667f,
					pid_calculate(&s_stirmotor_outter_pid,StirMotorData.TotalPosition*0.001220852f,
					TargetPosition*0.001220852f));
}